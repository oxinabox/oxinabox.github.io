...
**Output:**
    ...
    Plots.PlotText("A", Plots.Font("sans-serif", 38, :hcenter, :vcenter, 0.0, RGB{N0f8}(0.0,0.0,0.0)))
...
![svg]({{site.url}}/posts_assets/DataDeps.jl -- Repeatabled Data Setup for Repeatable Science_files/DataDeps.jl -- Repeatabled Data Setup for Repeatable Science_16_0.svg)
...
![svg]({{site.url}}/posts_assets/DataDeps.jl -- Repeatabled Data Setup for Repeatable Science_files/DataDeps.jl -- Repeatabled Data Setup for Repeatable Science_36_0.svg)
...
![svg]({{site.url}}/posts_assets/DataDeps.jl -- Repeatabled Data Setup for Repeatable Science_files/DataDeps.jl -- Repeatabled Data Setup for Repeatable Science_40_0.svg)
...
![svg]({{site.url}}/posts_assets/DataDeps.jl -- Repeatabled Data Setup for Repeatable Science_files/DataDeps.jl -- Repeatabled Data Setup for Repeatable Science_43_0.svg)
